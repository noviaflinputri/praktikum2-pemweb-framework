...
// 3. Buat Fungsi Formatter (Data Adapter)
...
// 4. Ambil dan Format Daftar Tugas (getTasks)
...
// 5. Ambil dan Format Satu Tugas Spesifik (getTaskById)
...
// 6. Buat Utilitas Statistik Data (getTaskStats)
